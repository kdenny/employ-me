    ...
    this.users = [
      {
        ...
        name: 'Farmer',
        age: "3 jobs",
        job_title: 'Picking veggies, making paper',
        profile_image_url: 'assets/img/farmer.png'
      },
      {
        id: 2,
        name: 'KFC / Taco Bell',
        age: "(Terrible Job, FYI)",
        job_title: 'Drive Thru Cashier',
        profile_image_url: 'assets/img/kfc.png'
      }
      //{
      //  id: 3,
      //  name: 'Ben Affleck',
